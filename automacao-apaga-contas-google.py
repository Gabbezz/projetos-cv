...
# 1. Substituir os números no parênteses com os respectivos X e Y com o código "position"
...
# 2. Definir a quantidade de perfis para exlcuir
QUANTIDADE_DE_PERFIS = 119  # Alterar esse número
...
try:
    ...
    # Pausa de segurança para acessar a janela do chrome
    time.sleep(5)
    print("INICIANDO...")
